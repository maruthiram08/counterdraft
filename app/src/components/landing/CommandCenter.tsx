...
export const CommandCenter: React.FC = () => {
  ...
  return (
    <div className="bg-zinc-50/50 rounded-3xl border border-zinc-200 shadow-[0_40px_80px_-20px_rgba(0,0,0,0.08)] overflow-hidden flex flex-col min-h-[600px] animate-fade-in-up">
      {/* App Header */}
      <div className="h-16 bg-white border-b border-zinc-100 flex items-center justify-between px-6 shrink-0">
        <div className="flex items-center gap-8">
          ...
          <div className="flex items-center gap-2 text-zinc-400 text-xs font-bold uppercase tracking-widest">
            ...
            <span className="text-zinc-900">Command Center</span>
          </div>
        </div>
        <div className="flex items-center gap-4">
          <button className="text-xs font-bold text-zinc-500 hover:text-zinc-900 transition-colors">Filter View</button>
          <button className="bg-zinc-900 text-white text-xs font-bold px-4 py-2 rounded-lg hover:bg-black transition-colors flex items-center gap-2">
            <svg className="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 4v16m8-8H4"></path></svg>
            New Logic
          </button>
        </div>
